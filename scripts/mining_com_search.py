...
# Windows runners may expose a GBK console.  The collector emits article titles
# from the live page, so force UTF-8 output instead of failing after extraction.
