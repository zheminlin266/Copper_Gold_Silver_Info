"""
Check X posts for 2026-07-06 Beijing window using Playwright + storage_state.
"""
import asyncio, sys
...
OUTPUT_FILE = PROJECT_ROOT / "x_outputs" / "2026-07-06_x_raw_materials.txt"

BEIJING_TZ = timezone(timedelta(hours=8))
DAY = "2026-07-06"
WINDOW_START = datetime(2026, 7, 6, 0, 0, 0, tzinfo=BEIJING_TZ)
WINDOW_END = datetime(2026, 7, 6, 23, 59, 59, tzinfo=BEIJING_TZ)
...
async def main():
    if not STORAGE_STATE.exists():
        print("ERROR: x_auth.json not found.")
        sys.exit(1)
